...
## Programmer Notes
When first looking at ways to sort the queue I looked at w3schools's Python DSA (https://www.w3schools.com/python/python_dsa.asp). 

Variation 1 is based on the w3school's lesson on Bubble sorts. 
